...
import com.example.movil.interfaces.DetalleDepositosService;
...
public class DetalleDepositos extends AppCompatActivity {

    ImageView imageViewGota;
    TextView textViewNombre;
    TextView textViewCapacidadDepositos;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_depositos);
        ...
        textViewCapacidadDepositos = findViewById(R.id.textViewCapacidadDetalle);
        buttonDescargar = findViewById(R.id.textViewDescargar);
        layoutButton = findViewById(R.id.layoutButton);
        listView = findViewById(R.id.listView);

        Bundle bundle = getIntent().getExtras();
        id = bundle.getInt("id_deposito");
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        DetalleDepositosService detalleDepositosService = retrofit.create(DetalleDepositosService.class);
        Call<List<PostDetalle>> call = detalleDepositosService.find(id);
        call.enqueue(new Callback<List<PostDetalle>>() {
            ...
            public void onResponse(Call<List<PostDetalle>> call, Response<List<PostDetalle>> response) {
                ...
                ListDetalleAdapter adapter = new ListDetalleAdapter(DetalleDepositos.this, postList);
