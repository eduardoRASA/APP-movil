...
import com.example.movil.interfaces.DetalleTanquesService;
...
public class DetalleTanques extends AppCompatActivity {

    ImageView imageViewGota;
    TextView textViewNombre;
    TextView textViewCapacidad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_tanques);
        ...
        textViewCapacidad = findViewById(R.id.textViewCapacidadDetalle);
        buttonDescargar = findViewById(R.id.textViewDescargar);
        layoutButton = findViewById(R.id.layoutButton);
        listView = findViewById(R.id.listView);

        Bundle bundle = getIntent().getExtras();
        id = bundle.getInt("id_tanque");
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        DetalleTanquesService detalleTanquesService = retrofit.create(DetalleTanquesService.class);
        Call<List<PostDetalle>> call = detalleTanquesService.find(id);
        call.enqueue(new Callback<List<PostDetalle>>() {
            ...
            public void onResponse(Call<List<PostDetalle>> call, Response<List<PostDetalle>> response) {
                ...
                ListDetalleAdapter adapter = new ListDetalleAdapter(DetalleTanques.this, postList);
